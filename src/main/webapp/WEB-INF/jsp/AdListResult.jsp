...
<%-- Widget Container --%>
content.push('<div class="ctsrch_boxContainer">');

<%-- Header --%>
content.push('<div class="ctsrch_header">');
content.push('    <div class="ctsrch_headerText">More to Try Nearby</div>');
content.push('</div>');

<%-- Content Container --%>
content.push('<div class="ctsrch_container">');

<%-- Loop for 3 Businesses --%>
<%
...
<%-- Dividing Line --%>
<% if(i < 2) { %>
content.push('<div class="ctsrch_lineMargin"></div>');
<% } %>
