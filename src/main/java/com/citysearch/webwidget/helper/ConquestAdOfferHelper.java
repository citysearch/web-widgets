...
import com.citysearch.webwidget.action.ConquestAdOfferAction;
...
public class ConquestAdOfferHelper {
    ...
    private String getQueryString(ConquestAdOfferRequest request) throws CitysearchException {
        ...
        if(!StringUtils.isBlank( request.getWhere()) && (StringUtils.isBlank( request.getLatitude()) || StringUtils.isBlank( request.getLongitude()))){
	        strBuilder.append(CommonConstants.SYMBOL_AMPERSAND);
     ...
     * @throws CitysearchException
     */
    public void validateRequest(ConquestAdOfferRequest request) throws InvalidRequestParametersException,
            CitysearchException{
        ...
        log.info("=========End offersHelper validateRequest()============================ >" + errors);   
    }    
     ...
     * @throws CitysearchException
     */
    public List<ConquestAdOffer> getOffers( ConquestAdOfferRequest request) throws InvalidRequestParametersException,
            CitysearchException {
        ...
        */        
	    ...
	    while(it.hasNext()){
             ...
             if( profile != null ){
	             ...
	             offer.setDistance(new Double(HelperUtil.getDistance(new BigDecimal(request.getLatitude()), new BigDecimal(request.getLongitude()), new BigDecimal(offer.getLatitude()), new BigDecimal(offer.getLongitude()))).toString()); 
            }
        }    
     ...
     * @throws CitysearchException
     */
    private List<ConquestAdOffer> getOffersList(List<Element> offerElemList) throws CitysearchException {  
