...
public class OffersBackfillAction extends AbstractCitySearchAction implements
    ...
    public String execute() throws CitysearchException {
        ...
        String backfillFor = (String) getHttpRequest().getAttribute(REQUEST_ATTRIBUTE_BACKFILL_FOR);
        offersRequest.setAdUnitSize(adUnitSize);
        offersRequest.setAdUnitName(AD_UNIT_NAME);
        offersRequest.setDisplaySize(displaySize);
        offersRequest.setLatitude(latitude);
        offersRequest.setLongitude(longitude);
        ...
        try {
            ...
            if (offers == null || offers.isEmpty()) {
                ...
                getHttpRequest().setAttribute(REQUEST_ATTRIBUTE_BACKFILL_FOR, backfillFor);
                return "backfill";
            }
