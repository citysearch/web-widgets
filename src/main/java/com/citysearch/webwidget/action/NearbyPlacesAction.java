...
public class NearbyPlacesAction extends AbstractCitySearchAction implements
	...
	private void set1x1TrackingPixel() throws CitysearchException {
		String trackingUrlKey = TRACKING_1x1_NEARBY_300x250_3P_0B_0S_0H;
		...
		if (pfpResultsSize == 2 && backfillSize == 0 && searchResultsSize == 0
				&& houseAdsSize == 0) {
			trackingUrlKey = TRACKING_1x1_NEARBY_300x250_2P_0B_0S_0H;
		} else if (pfpResultsSize == 2 && backfillSize == 0
