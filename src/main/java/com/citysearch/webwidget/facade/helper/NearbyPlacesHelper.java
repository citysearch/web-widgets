...
public class NearbyPlacesHelper {
	public static List<NearbyPlace> addDefaultImages(
			List<NearbyPlace> nearByPlaces, String contextPath)
	...
	public static NearbyPlace toBackfill(RequestBean request, PFPAd ad)
			throws CitysearchException {
		...
		description = Utils.getAbbreviatedString(description, descLengthProp
				.toString());
		...
		String adDisplayTrackingUrl = Utils.getTrackingUrl(nbp
	...
	public static NearbyPlace toNearbyPlace(RequestBean request, PFPAd ad)
		...
		String distanceStr = ad.getDistance();
