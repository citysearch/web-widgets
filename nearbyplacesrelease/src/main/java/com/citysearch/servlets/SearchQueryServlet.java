...
public class SearchQueryServlet extends HttpServlet {
    ...
    private void processRequest(HttpServletRequest req, HttpServletResponse res)
        ...
        try {
            String queryString = reqHelper.getQueryString(CommonConstants.SEARCH_API_TYPE);
    ...
    private void processResponse(InputStream input, HttpServletRequest req)
        ...
        req.setAttribute(CommonConstants.SEARCH_API_QUERIED, CommonConstants.SEARCH_API_QUERIED);
    }
