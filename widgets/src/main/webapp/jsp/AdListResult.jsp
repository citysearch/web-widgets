				...
				%>
						...
						<div class="ctsrch_leftSide">
							<div class="ctsrch_bigStar">
								<a href="javascript:Launch('<%= listingIdURL %>')" ><img src="<%= adListBean.getAdImageURL() %>" /></a>
							</div>
						...
						<div class="ctsrch_rightSide">
							<div class="ctsrch_mainLink" >
								<a class="ctsrch_busNameFont" href="javascript:Launch('<%= listingIdURL %>')" ><%=  adListBean.getName() %></a>
							</div>
						<% if(adListBean.getRatings() != 0.0){ %>
							...
							<div class="ctsrch_stars">
								<% for(int val = 0; val < rating.length; val++){ 
									 switch(rating[val]){ 
									   case 2: %><img src="img/Star.png" class="ctsrch_starImg"/><% break;
										case 1: %><img src="img/HalfStar.png" class="ctsrch_starImg"/><% break ;
										case 0: %><img src="img/EmptyStar.png" class="ctsrch_starImg"/><% break;
									}
								} %>
